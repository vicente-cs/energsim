...
class Residencia(Consumidor):
    def __init__(self, nome, taxa, eletrodomesticos: List[Eletrodomestico] = None):
        ...
        self._eletro_selecao = [TV, Eletrodomestico, LavaRoupa, Geladeira, Fogao, ArCondicionado, Radio, Computador, Ventilador]
        self._acoes.insert(
            0,
...
class LavaRoupa(Eletrodomestico):
    ...
    cadastro = [
        ...
        },
        {
            ...
            "message": "Modelo Lava Roupa",
            "choices": [
                {"name": 'Máquina de Lavar Roupa', "value": 500},               
            ],
        },
        {
            "type": "input",
    ...
    cadastro = [
        {
            "type": "input",
            "name": "nome",
            "message": "Geladeira (1 ou 2 portas)",
            "validate": lambda x: x != "",
        },
        {
            "type": "list",
            ...
            "message": "Geladeira (1 ou 2 portas)",
            "choices": [
                {"name": 'Geladeira 1 porta', "value": 90},
                {"name": 'Geladeira 2 portas', "value": 130},
            ],
        },
        {
            "type": "input",
...
class ArCondicionado(Eletrodomestico):
    ...
    cadastro = [
        ...
        },
        {
            ...
            "choices": [
                {"name": 'AR-CONDICIONADO 7.500 BTU', "value": 1000},
                {"name": 'AR-CONDICIONADO 10.000 BTU', "value": 1350},
                {"name": 'AR-CONDICIONADO 12.000 BTU', "value": 1450},
                {"name": 'AR-CONDICIONADO 15.000 BTU', "value": 2000},
                {"name": 'AR-CONDICIONADO 18.000 BTU', "value": 2100},            
            ],
        },
        {
            "type": "input",
...
class Radio(Eletrodomestico):
    ...
    cadastro = [
        ...
        },
        {
            ...
            "choices": [
                {"name": 'Rádio elétrico (grande)', "value": 45},
                {"name": 'Rádio elétrico (pequeno)', "value": 10},
                {"name": 'Rádio relógio', "value": 5},        
            ],
        },
        {
            "type": "input",
...
class Ventilador(Eletrodomestico):
    ...
    cadastro = [
        ...
        },
        {
            ...
            "choices": [
                {"name": 'Ventilador de teto', "value": 120},     
                {"name": 'Ventilador pequeno', "value": 120},    
            ],
        },
